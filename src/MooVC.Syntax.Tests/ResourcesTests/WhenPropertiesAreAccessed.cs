namespace MooVC.Syntax.ResourcesTests;
...
public sealed class WhenPropertiesAreAccessed
{
    ...
    {
        // Arrange
        Type[] resourceTypes = typeof(Snippet).Assembly
            .GetTypes()
    ...
    private static bool IsGeneratedResourceType(Type type)
    {
        return type.Name.EndsWith("_Resources", StringComparison.Ordinal);
    }

    private static int ReadResources(Type resourceType)
    {
    ...
    private static PropertyInfo GetProperty(Type resourceType, string name)
    {
