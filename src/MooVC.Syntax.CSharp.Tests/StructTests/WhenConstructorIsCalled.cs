...
public sealed class WhenConstructorIsCalled
{
    ...
    public async Task GivenDefaultsThenStructIsUndefined()
    {
        ...
        _ = await Assert.That(subject.Behavior).IsEqualTo(Struct.Kinds.Default);
    ...
    public async Task GivenValuesThenPropertiesAreAssigned()
    {
        ...
        var constructor = new Constructor { Scope = Scopes.Private };
        ...
        _ = await Assert.That(subject.Behavior).IsEqualTo(Struct.Kinds.ReadOnly);
        _ = await Assert.That(subject.IsPartial).IsTrue();
