...
public sealed class WhenWithComparisonsIsCalled
{
    ...
    public void GivenValueThenReturnsNewInstanceWithUpdatedComparisons()
    {
        ...
        ImmutableArray<Comparison> updatedComparisons = [ComparisonTestsData.Create(@operator: Comparison.Type.Inequality)];
        ...
        result.Comparisons.ShouldBe(updatedComparisons);
