namespace MooVC.Serialization
{
        ...
        : SerializableObject
    {
        ...
        private InternalSerializableObject(SerializationInfo info, StreamingContext context)
        {
            ...
            Value1 = info.GetInternalValue<object>(nameof(Value1));
            Value2 = info.GetInternalValue<Guid>(nameof(Value2));
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddInternalValue(nameof(Value1), Value1);
            info.AddInternalValue(nameof(Value2), Value2);
