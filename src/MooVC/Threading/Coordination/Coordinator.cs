namespace MooVC.Threading.Coordination
{
        ...
        : ICoordinator<T>
    {
        ...
        private readonly ConcurrentDictionary<string, SemaphoreSlim> _contexts = new ConcurrentDictionary<string, SemaphoreSlim>();
        ...
        public async Task<IContext<T>> Apply(T subject, CancellationToken cancellationToken, TimeSpan? timeout = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(subject), ApplyAsyncContextRequired);
            }
