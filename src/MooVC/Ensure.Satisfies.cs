...
public static partial class Ensure
{
    ...
    public static T Satisfies<T>(
        ...
        where T : struct
    {
        return PerformSatisfies(argument, argumentName, @default, message, predicate);
    }
#else
    public static T Satisfies<T>(
        T? argument,
    ...
    private static T PerformSatisfies<T>(T? argument, string? argumentName, T? @default, string? message, Func<T, bool> predicate)
        where T : struct
    {
