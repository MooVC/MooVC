...
namespace MooVC.Syntax.CSharp.Containers {
    ...
    internal class Definition_Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Construct belonging to `{0}` must be provided..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Namespace to which the Construct belongs must be provided..
        /// </summary>
